...
function JSXExamples() {
    ...
    const user ={
        ...
        lastName: 'ไทยเจริญ',
        age: 20,
        hobbies: ['Drawing', 'Painting', 'Playing game']
    };
    ...
    return(
        ...
        <div className="js-examples">
            ...
            <section>
                ...
                {(() => {
                    if (user.age >= 18) {
                        return <p>{formatName(user)} บรรลุนิติภาวะแล้ว</p>;
                    } else {
                        return <p>{formatName(user)} ยังไม่บรรลุนิติภาาวะ</p>;
                    }
                })()}
            </section>
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'Cupcakes', price: 35, inStock: true },
                        { id: 2, name: 'Shortcakes', price: 125, inStock: true },
                        { id: 3, name: 'Cheesecake', price: 75, inStock: false }
                    ].map(product => (
